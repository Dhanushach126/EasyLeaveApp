                    ...
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <form class="col s12" name="chngpwd" method="post" action="updatepass.jsp">
...
<div class="input-field col s12">
<button type="submit" name="add" class="waves-effect waves-light btn indigo m-b-xs">Change</button>
