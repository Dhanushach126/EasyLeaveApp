...
try
            {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.EmailId where tblleaves.Status=? order by lid desc");
                ps.setInt(1,status);
                ...
                while(rs.next())
                {
                                  ...
                                  %>                                        <tr>
                                      <td><%=rs.getInt(1)%></td>
                                      <td><a href="editemployee.jsp?empid=<%= rs.getInt("id")%>" target="_blank"><%= rs.getString("FirstName")+" "+rs.getString("LastName")%></a></td>
