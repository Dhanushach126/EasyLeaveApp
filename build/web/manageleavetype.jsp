...
try
            {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT * from tblleavetype");
                ...
                while(rs.next())
                {
                                  ...
                                  %>                                        <tr>
                                      <td><%=rs.getInt(1)%></td>
                                            ...
                                            <td><a href="deleteleavetype.jsp?del=<%=rs.getInt(1)%>" onclick="return confirm('Do you want to delete');"> <i class="material-icons">delete_forever</i></a></td>
                                        </tr>
                                        <%
                                        }    
