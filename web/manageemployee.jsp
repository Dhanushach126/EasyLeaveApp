...
try
            {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT * from tblemployees");
                ...
                while(rs.next())
                {
                                  ...
                                  %>                                        <tr>
                                      <td><%=rs.getInt(1)%></td>
                                            ...
                                            <td><a href="deleteemployee.jsp?del=<%=rs.getInt(1)%>" onclick="return confirm('Do you want to delete');"> <i class="material-icons">delete_forever</i></a></td>
                                        </tr>
                                        <%
                                        }    
